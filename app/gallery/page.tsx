    ...
    <div className="min-h-screen bg-black text-white selection:bg-red-500/30">
      ...
      <main className="pt-32 pb-20 overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 mb-16 text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-6 px-5 py-2 rounded-full border border-red-500/30 bg-red-500/10 text-red-400 font-medium tracking-widest text-sm backdrop-blur-md">
              <Music2 className="w-4 h-4" /> LIVE ROCK & METAL
            </div>
            
            {/* Mercury Logo Image */}
            <div className="relative w-full max-w-[500px] mx-auto aspect-[4/1] mb-8">
               <Image 
            ...
            <p className="text-zinc-300 max-w-2xl mx-auto text-xl font-light tracking-wide mb-8">
        ...
        <div className="container mx-auto px-4 mt-32 relative z-10">
          <motion.h2 
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="text-4xl font-black mb-12 text-center tracking-tighter"
          >
            Live <span className="text-red-500">Moments</span>
          </motion.h2>
